...
$settings->add(new admin_setting_configtext('openmeetings_url', get_string('url', 'openmeetings'), get_string('urlDesc', 'openmeetings'), "https://localhost:5443/openmeetings", PARAM_TEXT));
...
$settings->add(new admin_setting_configcheckbox('openmeetings_recordingAllowed', get_string('Allow_Recording', 'openmeetings'), get_string('Allow_RecordingDesc', 'openmeetings'), 1));
